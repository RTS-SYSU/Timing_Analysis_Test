...
@matrix1_A = dso_local global [100 x i32] zeroinitializer, align 4, !dbg !0
@matrix1_B = dso_local global [100 x i32] zeroinitializer, align 4, !dbg !5
@matrix1_C = dso_local global [100 x i32] zeroinitializer, align 4, !dbg !12
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %exitcond.not = icmp eq i32 %i.0, 100, !dbg !153
...
for.cond1:                                        ; preds = %for.inc5, %for.end
  ...
  %exitcond1.not = icmp eq i32 %i.1, 100, !dbg !167
...
for.cond8:                                        ; preds = %for.inc12, %for.end7
  ...
  %exitcond2.not = icmp eq i32 %i.2, 100, !dbg !180
...
entry:
  call arm_aapcs_vfpcc void @matrix1_pin_down(i32* noundef getelementptr inbounds ([100 x i32], [100 x i32]* @matrix1_A, i32 0, i32 0), i32* noundef getelementptr inbounds ([100 x i32], [100 x i32]* @matrix1_B, i32 0, i32 0), i32* noundef getelementptr inbounds ([100 x i32], [100 x i32]* @matrix1_C, i32 0, i32 0)) #4, !dbg !193
  ret void, !dbg !194
}
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %exitcond.not = icmp eq i32 %i.0, 100, !dbg !204
...
for.inc:                                          ; preds = %for.body
  %arrayidx = getelementptr inbounds [100 x i32], [100 x i32]* @matrix1_C, i32 0, i32 %i.0, !dbg !208
...
entry:
  call void @llvm.dbg.value(metadata i32* getelementptr inbounds ([100 x i32], [100 x i32]* @matrix1_A, i32 0, i32 0), metadata !218, metadata !DIExpression()), !dbg !219
  call void @llvm.dbg.value(metadata i32* getelementptr inbounds ([100 x i32], [100 x i32]* @matrix1_B, i32 0, i32 0), metadata !220, metadata !DIExpression()), !dbg !219
  call void @llvm.dbg.value(metadata i32* getelementptr inbounds ([100 x i32], [100 x i32]* @matrix1_C, i32 0, i32 0), metadata !221, metadata !DIExpression()), !dbg !219
...
for.cond:                                         ; preds = %for.inc13, %entry
  ...
  %p_c.0 = phi i32* [ getelementptr inbounds ([100 x i32], [100 x i32]* @matrix1_C, i32 0, i32 0), %entry ], [ %p_c.1, %for.inc13 ], !dbg !226
  ...
  %exitcond2.not = icmp eq i32 %k.0, 10, !dbg !227
...
for.cond1:                                        ; preds = %for.inc10, %for.body
  ...
  %p_a.0 = phi i32* [ getelementptr inbounds ([100 x i32], [100 x i32]* @matrix1_A, i32 0, i32 0), %for.body ], [ %p_a.1, %for.inc10 ], !dbg !235
  ...
  %exitcond1.not = icmp eq i32 %i.0, 10, !dbg !236
  br i1 %exitcond1.not, label %for.end12, label %for.body3, !dbg !238

for.body3:                                        ; preds = %for.cond1
  %mul = mul nuw nsw i32 %k.0, 10, !dbg !239
  %arrayidx = getelementptr inbounds [100 x i32], [100 x i32]* @matrix1_B, i32 0, i32 %mul, !dbg !241
...
for.cond4:                                        ; preds = %for.inc, %for.body3
  ...
  %exitcond.not = icmp eq i32 %f.0, 10, !dbg !249
...
!1 = distinct !DIGlobalVariable(name: "matrix1_A", scope: !2, file: !7, line: 82, type: !8, isLocal: false, isDefinition: true)
...
!3 = !DIFile(filename: "/workspaces/llvmta/testcases/singletest/matrix1/matrix1.c", directory: "/workspaces/llvmta/testcases/singletest/ludcmp")
!4 = !{!0, !5, !12}
!5 = !DIGlobalVariableExpression(var: !6, expr: !DIExpression())
!6 = distinct !DIGlobalVariable(name: "matrix1_B", scope: !2, file: !7, line: 83, type: !8, isLocal: false, isDefinition: true)
!7 = !DIFile(filename: "matrix1/matrix1.c", directory: "/workspaces/llvmta/testcases/singletest")
!8 = !DICompositeType(tag: DW_TAG_array_type, baseType: !9, size: 3200, elements: !10)
!9 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!10 = !{!11}
!11 = !DISubrange(count: 100)
!12 = !DIGlobalVariableExpression(var: !13, expr: !DIExpression())
!13 = distinct !DIGlobalVariable(name: "matrix1_C", scope: !2, file: !7, line: 84, type: !8, isLocal: false, isDefinition: true)
...
!137 = distinct !DISubprogram(name: "matrix1_pin_down", scope: !7, file: !7, line: 91, type: !138, scopeLine: 92, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !141)
!138 = !DISubroutineType(types: !139)
!139 = !{null, !140, !140, !140}
!140 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !9, size: 32)
!141 = !{}
!142 = !DILocalVariable(name: "A", arg: 1, scope: !137, file: !7, line: 91, type: !140)
!143 = !DILocation(line: 0, scope: !137)
!144 = !DILocalVariable(name: "B", arg: 2, scope: !137, file: !7, line: 91, type: !140)
!145 = !DILocalVariable(name: "C", arg: 3, scope: !137, file: !7, line: 91, type: !140)
!146 = !DILocalVariable(name: "x", scope: !137, file: !7, line: 94, type: !147)
!147 = !DIDerivedType(tag: DW_TAG_volatile_type, baseType: !9)
!148 = !DILocation(line: 94, column: 16, scope: !137)
!149 = !DILocalVariable(name: "i", scope: !137, file: !7, line: 93, type: !9)
!150 = !DILocation(line: 97, column: 9, scope: !151)
!151 = distinct !DILexicalBlock(scope: !137, file: !7, line: 97, column: 3)
!152 = !DILocation(line: 0, scope: !151)
!153 = !DILocation(line: 97, column: 19, scope: !154)
!154 = distinct !DILexicalBlock(scope: !151, file: !7, line: 97, column: 3)
!155 = !DILocation(line: 97, column: 3, scope: !151)
!156 = !DILocation(line: 98, column: 14, scope: !154)
!157 = !DILocation(line: 98, column: 5, scope: !154)
!158 = !DILocation(line: 98, column: 12, scope: !154)
!159 = !DILocation(line: 97, column: 29, scope: !154)
!160 = !DILocation(line: 97, column: 3, scope: !154)
!161 = distinct !{!161, !155, !162, !163}
!162 = !DILocation(line: 98, column: 14, scope: !151)
!163 = !{!"llvm.loop.mustprogress"}
!164 = !DILocation(line: 101, column: 9, scope: !165)
!165 = distinct !DILexicalBlock(scope: !137, file: !7, line: 101, column: 3)
!166 = !DILocation(line: 0, scope: !165)
!167 = !DILocation(line: 101, column: 19, scope: !168)
!168 = distinct !DILexicalBlock(scope: !165, file: !7, line: 101, column: 3)
!169 = !DILocation(line: 101, column: 3, scope: !165)
!170 = !DILocation(line: 102, column: 14, scope: !168)
!171 = !DILocation(line: 102, column: 5, scope: !168)
!172 = !DILocation(line: 102, column: 12, scope: !168)
!173 = !DILocation(line: 101, column: 30, scope: !168)
!174 = !DILocation(line: 101, column: 3, scope: !168)
!175 = distinct !{!175, !169, !176, !163}
!176 = !DILocation(line: 102, column: 14, scope: !165)
!177 = !DILocation(line: 105, column: 9, scope: !178)
!178 = distinct !DILexicalBlock(scope: !137, file: !7, line: 105, column: 3)
!179 = !DILocation(line: 0, scope: !178)
!180 = !DILocation(line: 105, column: 19, scope: !181)
!181 = distinct !DILexicalBlock(scope: !178, file: !7, line: 105, column: 3)
!182 = !DILocation(line: 105, column: 3, scope: !178)
!183 = !DILocation(line: 106, column: 5, scope: !181)
!184 = !DILocation(line: 106, column: 12, scope: !181)
!185 = !DILocation(line: 105, column: 30, scope: !181)
!186 = !DILocation(line: 105, column: 3, scope: !181)
!187 = distinct !{!187, !182, !188, !163}
!188 = !DILocation(line: 106, column: 14, scope: !178)
!189 = !DILocation(line: 107, column: 1, scope: !137)
!190 = distinct !DISubprogram(name: "matrix1_init", scope: !7, file: !7, line: 110, type: !191, scopeLine: 111, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !141)
!191 = !DISubroutineType(types: !192)
!192 = !{null}
!193 = !DILocation(line: 112, column: 3, scope: !190)
!194 = !DILocation(line: 113, column: 1, scope: !190)
!195 = distinct !DISubprogram(name: "matrix1_return", scope: !7, file: !7, line: 119, type: !196, scopeLine: 120, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !141)
!196 = !DISubroutineType(types: !197)
!197 = !{!9}
!198 = !DILocalVariable(name: "checksum", scope: !195, file: !7, line: 122, type: !9)
!199 = !DILocation(line: 0, scope: !195)
!200 = !DILocalVariable(name: "i", scope: !195, file: !7, line: 121, type: !9)
!201 = !DILocation(line: 125, column: 9, scope: !202)
!202 = distinct !DILexicalBlock(scope: !195, file: !7, line: 125, column: 3)
!203 = !DILocation(line: 0, scope: !202)
!204 = !DILocation(line: 125, column: 18, scope: !205)
!205 = distinct !DILexicalBlock(scope: !202, file: !7, line: 125, column: 3)
!206 = !DILocation(line: 125, column: 3, scope: !202)
!207 = !DILocation(line: 126, column: 5, scope: !205)
!208 = !DILocation(line: 126, column: 17, scope: !205)
!209 = !DILocation(line: 126, column: 14, scope: !205)
!210 = !DILocation(line: 125, column: 28, scope: !205)
!211 = !DILocation(line: 125, column: 3, scope: !205)
!212 = distinct !{!212, !206, !213, !163}
!213 = !DILocation(line: 126, column: 30, scope: !202)
!214 = !DILocation(line: 128, column: 21, scope: !195)
!215 = !DILocation(line: 128, column: 12, scope: !195)
!216 = !DILocation(line: 128, column: 3, scope: !195)
!217 = distinct !DISubprogram(name: "matrix1_main", scope: !7, file: !7, line: 136, type: !191, scopeLine: 137, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !141)
!218 = !DILocalVariable(name: "p_a", scope: !217, file: !7, line: 138, type: !140)
!219 = !DILocation(line: 0, scope: !217)
!220 = !DILocalVariable(name: "p_b", scope: !217, file: !7, line: 139, type: !140)
!221 = !DILocalVariable(name: "p_c", scope: !217, file: !7, line: 140, type: !140)
!222 = !DILocalVariable(name: "k", scope: !217, file: !7, line: 142, type: !9)
!223 = !DILocation(line: 145, column: 9, scope: !224)
!224 = distinct !DILexicalBlock(scope: !217, file: !7, line: 145, column: 3)
!225 = !DILocation(line: 0, scope: !224)
!226 = !DILocation(line: 140, column: 17, scope: !217)
!227 = !DILocation(line: 145, column: 18, scope: !228)
!228 = distinct !DILexicalBlock(scope: !224, file: !7, line: 145, column: 3)
!229 = !DILocation(line: 145, column: 3, scope: !224)
!230 = !DILocalVariable(name: "i", scope: !217, file: !7, line: 142, type: !9)
!231 = !DILocation(line: 149, column: 11, scope: !232)
!232 = distinct !DILexicalBlock(scope: !233, file: !7, line: 149, column: 5)
!233 = distinct !DILexicalBlock(scope: !228, file: !7, line: 145, column: 29)
!234 = !DILocation(line: 0, scope: !232)
!235 = !DILocation(line: 146, column: 9, scope: !233)
!236 = !DILocation(line: 149, column: 20, scope: !237)
!237 = distinct !DILexicalBlock(scope: !232, file: !7, line: 149, column: 5)
!238 = !DILocation(line: 149, column: 5, scope: !232)
!239 = !DILocation(line: 150, column: 27, scope: !240)
!240 = distinct !DILexicalBlock(scope: !237, file: !7, line: 149, column: 31)
!241 = !DILocation(line: 150, column: 14, scope: !240)
!242 = !DILocation(line: 152, column: 12, scope: !240)
!243 = !DILocalVariable(name: "f", scope: !217, file: !7, line: 142, type: !9)
!244 = !DILocation(line: 154, column: 13, scope: !245)
!245 = distinct !DILexicalBlock(scope: !240, file: !7, line: 154, column: 7)
!246 = !DILocation(line: 0, scope: !245)
!247 = !DILocation(line: 0, scope: !240)
!248 = !DILocation(line: 0, scope: !233)
!249 = !DILocation(line: 154, column: 22, scope: !250)
!250 = distinct !DILexicalBlock(scope: !245, file: !7, line: 154, column: 7)
!251 = !DILocation(line: 154, column: 7, scope: !245)
!252 = !DILocation(line: 155, column: 17, scope: !250)
!253 = !DILocation(line: 155, column: 26, scope: !250)
!254 = !DILocation(line: 155, column: 24, scope: !250)
!255 = !DILocation(line: 155, column: 14, scope: !250)
!256 = !DILocation(line: 155, column: 9, scope: !250)
!257 = !DILocation(line: 155, column: 30, scope: !250)
!258 = !DILocation(line: 155, column: 21, scope: !250)
!259 = !DILocation(line: 154, column: 28, scope: !250)
!260 = !DILocation(line: 154, column: 7, scope: !250)
!261 = distinct !{!261, !251, !262, !163}
!262 = !DILocation(line: 155, column: 30, scope: !245)
!263 = !DILocation(line: 158, column: 5, scope: !240)
!264 = !DILocation(line: 157, column: 10, scope: !240)
!265 = !DILocation(line: 149, column: 26, scope: !237)
!266 = !DILocation(line: 149, column: 5, scope: !237)
!267 = distinct !{!267, !238, !268, !163}
!268 = !DILocation(line: 158, column: 5, scope: !232)
!269 = !DILocation(line: 159, column: 3, scope: !233)
!270 = !DILocation(line: 145, column: 24, scope: !228)
!271 = !DILocation(line: 145, column: 3, scope: !228)
!272 = distinct !{!272, !229, !273, !163}
!273 = !DILocation(line: 159, column: 3, scope: !224)
!274 = !DILocation(line: 160, column: 1, scope: !217)
!275 = distinct !DISubprogram(name: "main", scope: !7, file: !7, line: 163, type: !196, scopeLine: 164, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !141)
!276 = !DILocation(line: 165, column: 3, scope: !275)
!277 = !DILocation(line: 166, column: 3, scope: !275)
!278 = !DILocation(line: 168, column: 10, scope: !275)
!279 = !DILocation(line: 168, column: 3, scope: !275)
