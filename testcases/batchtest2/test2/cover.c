...
int cover_swi120(int c) {
  ...
  _Pragma("loopbound min 120 max 120") for (i = 0; i < 120; i++) { c--; }
  return c;
}
...
int cover_swi50(int c) {
  ...
  _Pragma("loopbound min 50 max 50") for (i = 0; i < 50; i++) { c--; }
  return c;
}
...
int cover_swi10(int c) {
  ...
  _Pragma("loopbound min 10 max 10") for (i = 0; i < 10; i++) { c--; }
  return c;
}
