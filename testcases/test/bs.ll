; ModuleID = '/workspaces/llvmta/testcases/test/bs.c'
source_filename = "/workspaces/llvmta/testcases/test/bs.c"
...
define dso_local arm_aapcs_vfpcc i32 @bs() #0 !dbg !12 {
entry:
  %retval = alloca i32, align 4
  %call = call arm_aapcs_vfpcc i32 @binary_search(i32 noundef 8) #1, !dbg !16
  %0 = load i32, i32* %retval, align 4, !dbg !17
  ret i32 %0, !dbg !17
}
...
!1 = !DIFile(filename: "/workspaces/llvmta/testcases/test/bs.c", directory: "/workspaces/llvmta/testcases/tacle-bench", checksumkind: CSK_MD5, checksum: "bd8125837db9308c88c5ffb782c95b7d")
